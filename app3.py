...
<body class="bg-slate-900 text-slate-100 min-h-screen font-sans">
    ...
    <div class="container mx-auto px-4 py-8 max-w-5xl">
        <header class="text-center mb-10">
            ...
            <p class="text-slate-400">Environment State : <span class="text-yellow-400 font-mono text-xs">MASTER(ControlNet + ADetailer)</span></p>
        </header>
        ...
        <div class="bg-slate-800 border border-slate-700 rounded-xl p-6 shadow-xl mb-8">
            <form id="generate-form" class="space-y-5">
                ...
                <div class="bg-slate-900 p-4 rounded-lg border border-yellow-500/30">
                    <label class="block text-sm font-semibold text-yellow-400 mb-2">🦴 ControlNet Pose Reference (Optional)</label>
                    <p class="text-xs text-slate-400 mb-3">Upload a photo of a person. The AI will extract their skeleton and force your generated character to match that exact pose. Fixes bad anatomy instantly.</p>
        ...
        <div id="loading-area" class="hidden text-center py-12">
            ...
            <p class="text-yellow-400 font-medium animate-pulse">Running Neural Skeleton & Render Pipeline...</p>
        </div>
        ...
        <main>
            ...
            <div id="gallery" class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <p id="placeholder-text" class="text-slate-500 col-span-2 text-center py-12 border-2 border-dashed border-slate-800 rounded-xl">
                    No images generated in this session yet. Type a prompt above to begin.
                </p>
            </div>
        </main>
    </div>
    ...
    try:
        ...
        with torch.inference_mode():
            ...
            if target_width == 512 and target_height == 512:
                ...
                # High-Res Mode: Upscale, Detail, Face Fix
                for base_img in base_images:
